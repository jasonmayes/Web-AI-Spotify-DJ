# Spotify Web AI DJ - create the perfect mix of music using a natural voice interface to talk to the Spotify API, powered by Google's Gemma 2 model, to perform agentic behaviours
