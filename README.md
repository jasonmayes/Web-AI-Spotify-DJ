# Spotify Web AI DJ - create the perfect mix of music using a natural voice interface to talk to the Spotify API, powered by Google Gemma 2, to perform agentic behaviours
